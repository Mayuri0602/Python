...
sns.scatterplot(x = tips['total_bill'],
                y = tips['tip'], data = tips)
plt.title("Total_bill vs Tip")
plt.show()

# Categorical vs Numeric - Using boxplot or violin plot             sns.boxplot(x='sex', y='tip', data=df)

# Categorical vs Categorical - Use heatmap or grouped bar chart     (pd.crosstab(df['sex'], df['smoker']))
